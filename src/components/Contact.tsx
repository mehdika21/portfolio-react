  ...
  return (
    <footer id="contact" className="border-t border-white/5 py-16 text-center">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="footer-title text-xl sm:text-2xl font-serif mb-6">{t('contact.title')}</h2>
        ...
        <p className="rights text-xs text-slate-400">
          © <span id="year">{new Date().getFullYear()}</span> Mehdi Kaidi. {t('contact.rights')}
        </p>
      </div>
    </footer>
  );
